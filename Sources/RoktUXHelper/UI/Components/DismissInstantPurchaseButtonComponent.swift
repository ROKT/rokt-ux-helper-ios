//
//  DismissInstantPurchaseButtonComponent.swift
//  RoktUXHelper
//
...
private let kDismissInstantPurchaseButtonAnnouncement = "Dismiss Instant Purchase"

@available(iOS 15, *)
struct DismissInstantPurchaseButtonComponent: View {
    ...
    var style: DismissInstantPurchaseButtonStyles? {
        switch styleState {
        case .hovered:
    ...
    let model: DismissInstantPurchaseButtonViewModel
    ...
    func build() -> some View {
        createContainer()
            ...
            .accessibilityLabel(kDismissInstantPurchaseButtonAnnouncement)
    }
    ...
    private func handleDismissInstantPurchase() {
        model.sendDismissInstantPurchaseEvent()
